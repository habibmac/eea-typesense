...
class Vite {
    ...
    public static function __callStatic( $method, $params ) {
        if ( ! static::$instance || null === static::$instance ) {
     ...
     *
     */
    public static function enqueueScript( $handle, $src, $dependency = array(), $version = null, $inFooter = false ) {
        if ( in_array( $handle, ( static::$instance )->moduleScripts, true ) ) {
            if ( static::isDevMode() ) {
    ...
    public static function enqueueStyle( $handle, $src, $dependency = array(), $version = null ) {
        if ( ! static::isDevMode() ) {
            $assetFile = ( static::$instance )->getFileFromManifest( $src );
            $srcPath   = static::getProductionFilePath( $assetFile );
        } else {
    ...
    public static function isDevMode(): bool {
        return defined( 'GALA_TOOLKIT_DEVELOPMENT' ) && GALA_TOOLKIT_DEVELOPMENT === 'yes';
    }
    ...
    private static function getAssetPath(): string {
        return GALA_TOOLKIT_URL . 'assets/';
    }
