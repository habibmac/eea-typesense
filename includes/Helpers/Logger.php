...
namespace Galantis\Toolkit\Helpers;
...
class Logger {
	...
	private string $logBaseDirName = '/logs/';
	...
	public function mayBeMakeBaseDir() {
		try {
			...
			$this->logBaseDir = $uploads_folder['basedir'] . $this->logBaseDirName;
		} catch ( \Exception $e ) {
